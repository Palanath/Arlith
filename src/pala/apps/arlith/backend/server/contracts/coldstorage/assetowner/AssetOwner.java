package pala.apps.arlith.backend.server.contracts.coldstorage.assetowner;

import java.io.File;

import pala.apps.arlith.backend.server.contracts.coldstorage.ColdStorageObject;
import pala.apps.arlith.backend.server.contracts.coldstorage.FilesystemStorageObject;
