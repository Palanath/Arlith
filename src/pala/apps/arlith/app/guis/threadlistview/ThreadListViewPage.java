package pala.apps.arlith.app.guis.threadlistview;
...
import pala.apps.arlith.app.application.ArlithResources;
...
import pala.apps.arlith.app.guis.threadview.ThreadViewPage;
...
//			cbg.setFill(Color.SADDLEBROWN);
			...
			GUIUtils.applyClickAnimation(this, Color.GOLD, Color.RED, GUIUtils.CLICK_AND_RELEASE_ANIMATION_TIME,
					threadname);
			setSpacing(10);
		...
		public ThreadEntry(ClientUser user) throws CommunicationProtocolError, RuntimeException {
			...
			synchronized (checker) {
				if (checker.value == null)
					cbg.setImage(ArlithResources.MISSING_TEXTURE_IMAGE.get());
			}
