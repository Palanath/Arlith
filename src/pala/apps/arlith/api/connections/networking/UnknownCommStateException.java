...
/**
 * Used to signify that the state of a {@link Communicator}, regarding
 * connection between its endpoint, is unknown. This can be the result of a
 * malformed block, or if operations on the {@link Communicator}'s underlying
 * stream throw an {@link IOException}. Any time the class cannot guarantee that
 * a whole block was fully read will also result in an
