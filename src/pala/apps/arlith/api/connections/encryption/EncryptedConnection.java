package pala.apps.arlith.api.connections.encryption;
...
public class EncryptedConnection {
	...
	public EncryptedConnection(InputStream input, OutputStream output) throws InvalidKeyException, IOException,
		...
		IOStream str = IOStream.fromIOStreams(pala.apps.arlith.api.streams.InputStream.fromJavaInputStream(input),
				pala.apps.arlith.api.streams.OutputStream.fromJavaOutputStream(output));// Stuff for ease of
																						// writing.
		//
		// RSA
		//
